(function() {
    ...
    app.post("/register", function(req, res, next) {
        ...
        async.waterfall([
                function(callback) {
                   newrelic.startBackgroundTransaction('Register user', function executeTransaction() {
                ...
                function(custId, callback) {
                  ...
                  newrelic.startBackgroundTransaction('Get Carts', function executeTransaction() {
                    const transaction = newrelic.getTransaction();
                    transaction.insertDistributedTraceHeaders(headersObject);
                    request(options, function(error, response, body) {
                        if (error) {
    ...
    app.get("/login", function(req, res, next) {
        ...
        async.waterfall([
                function(callback) {
                  newrelic.startBackgroundTransaction('Login', function executeTransaction() {
                    const transaction = newrelic.getTransaction();
                    transaction.insertDistributedTraceHeaders(headersObject);
                    var options = {
                        headers: {
